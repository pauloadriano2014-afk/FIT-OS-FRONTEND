// src/components/Admin/TabFerramentas.js
import React from 'react';
import { View, Text, TouchableOpacity, StyleSheet } from 'react-native';
import { MaterialCommunityIcons } from '@expo/vector-icons';

export default function TabFerramentas({ isMasterCoach, theme, navigation, alunosAtivos }) {
    return (
        <>
            {/* Prescrição Avançada por IA - Apenas Master */}
            {isMasterCoach && (
            ...
            {/* 🔥 COFRE DE DIETAS - AGORA APENAS PARA MASTER COACH 🔥 */}
            {isMasterCoach && (
            ...
            {/* Laboratório de Fotos por IA - Apenas Master */}
            {isMasterCoach && (
            ...
            {/* Ranking de Gamification de XP - Apenas Master */}
            {isMasterCoach && (
