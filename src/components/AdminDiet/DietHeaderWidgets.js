...
export default function DietHeaderWidgets({ 
    ...
    return (
        <View style={styles.container}>
                    ...
                    {[
                        ...
                        <View key={label} style={styles.hMacroRow}>
                            ...
                            <View style={styles.hBarContainer}>
                                <View style={[styles.hBarBg, { backgroundColor: theme.isDark ? 'rgba(255,255,255,0.08)' : 'rgba(0,0,0,0.04)' }]}>
            ...
            {/* BOTÕES MODERNOS (PÍLULAS) */}
            <View style={styles.assistantRow}>
                <TouchableOpacity style={{ flex: 1 }} onPress={handlePressAI} disabled={isGenerating} activeOpacity={0.8}>
                    <LinearGradient 
...
const styles = StyleSheet.create({
    ...
    dashboardCard: { borderRadius: 24, padding: 20, marginBottom: 16, shadowColor: '#000', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.08, shadowRadius: 16, elevation: 4 },
    dashboardHeader: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 20, paddingBottom: 12, borderBottomWidth: 1 },
    ...
    assistantRow: { flexDirection: 'row', gap: 12, marginBottom: 16 },
    pillBtn: { flexDirection: 'row', alignItems: 'center', padding: 8, paddingRight: 16, borderRadius: 30, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.06, shadowRadius: 8, elevation: 3 },
